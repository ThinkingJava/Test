...
//    HTMLstr +='<s:param name="'+tr[i].getElementsByTagName('input')[2].name+'" value="'+tr[i].getElementsByTagName('input')[2].value+'"></s:param>';
   }
   else{
    tr[i].className = "";
   }
...
function check_business_all(id) {
    if (id == null || id == "") {
        ...
        if($("#check_"+id+"_check").attr("checked") == "checked"){
