...
<div id="box">
    ...
    <div id="wdzh_right">
      ...
      <div id="biaodan">
      <s:form action="order_save" namespace="/product" method="post">
      ...
      <table width="688" border="0" cellpadding="0" cellspacing="0">
          ...
          <s:iterator value="#session.selectcart">
          ...
          <tr>
			...
			为您节省：￥<s:property value="productMarketprice*amount - productPrice*amount"/>元</td>
                  <td width="104" align="center" class="red">
                    <input type="text" name="number" value='<s:property value="amount"/>' style="width:15px;">
                  </td>
                </tr>
              </table>
            </div></td>
