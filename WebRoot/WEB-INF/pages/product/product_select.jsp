	...
	<ul>
		<li>
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				...
				<tr >
					<td align="right" width="90">库存：</td>
					<td>
					<s:if test="stock-sellCount>0">
						<font color="red" ><s:property value="stock-sellCount"/></font>
						</s:if>
                    <s:elseif test="stock-sellCount<=0">
                  <font color="red"  style='text-decoration: line-through;'> 0</font>
                    </s:elseif>
					</td>
				</tr>
				<tr>
