...
//		// TODO Auto-generated method stub
//		return findMore(pageNo, end, null);
//	}
//	@Override
//	public List<T> findMore(int pageNo, int end, Map<String, String> orderby) {
//		// TODO Auto-generated method stub
//		final PageModel<T> pageModel = new PageModel<T>();//实例化分页对象
//		pageModel.setPageNo(pageNo);//设置当前标号
//		pageModel.setPageSize(end);//设置加载条数
//		getTemplate().execute(new HibernateCallback() {//执行内部方法
//			@Override
//			public Object doInHibernate(Session session)
//					throws HibernateException, SQLException {
...
//	}
	...
	protected int getFirstResult(int pageNo,int maxResult){
		...
		System.out.println("DaoSupport--->>getFirstResult()");
	...
	protected void setQueryParams(Query query, Object[] queryParams){
		...
		System.out.println("DaoSupport--->>setQueryParams()");
	}
	/**
	 * 创建排序hql语句
	 * @param orderby
	...
	protected String createOrderBy(Map<String, String> orderby){
		...
		System.out.println("DaoSupport--->>createOrderBy()");
		return sb.toString();
	}
	/**
	 * 获取Session对象
