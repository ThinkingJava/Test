...
CREATE TABLE `attend` (
  ...
  `imagepath` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '学生图片',
...
insert  into `attend`(`attendid`,`studentid`,`courseid`,`status`,`imagepath`,`datatime`) values (1,'081101','101',1,'',NULL);
